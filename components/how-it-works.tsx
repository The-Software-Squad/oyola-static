import img1 from '../public/work-pic-1@2x.png'
import img2 from '../public/work-pic-2@2x.png'
import img3 from '../public/work-pic-3@2x.png'
            ...
            {data.map((item, index) => {
                return (
                    <div key={index} className='w-64 flex   flex-col items-center justify-stretch my-10 gap-3'>
                        <img className=' w-full h-auto object-cover' src={item.icon.src} alt="" />
