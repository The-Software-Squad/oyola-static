...
export default function Footer() {
  return (
    <footer className=" bg-white text-gray-400 border-t-[1px]">
      <div className="flex flex-col px-4 md:px-0 md:flex-row gap-5 items-start justify-evenly">
        ...
        <div className="text-left flex flex-col items-start justify-start  ">
          ...
          <div className="flex flex-row gap-10">
            ...
            {/* instagram */}
            <a
              href="https://www.instagram.com/oyola.in/"
              target="_blank"
              className="hover:text-gray-900"
            >
              <svg
            ...
            {/* facebook */}
            <a
              href="https://www.facebook.com/arakuvalleytourism"
              target="_blank"
              className="hover:text-gray-900"
            >
              <svg
        ...
        <div className="text-left    ">
          ...
          <p className=" text-md list-disc text-left font-poppins">
            Jalatharangini road Araku, India - 531151
          </p>
        </div>
      </div>
      <div className="w-full flex justify-center items-center text-xs pt-10">
